const en = {
  ...
  heroLead:"Your ChatGPT Codex/Work and Claude allowance, remaining percentage, and next reset. Right where you work.",
  ...
  feature1Title:"Two time windows",feature1Body:"Separate percentages for 5-hour, weekly, or monthly ChatGPT and Claude allowances, with local reset times and countdowns.",
  ...
  privacyBody:"The extension reads your allowance using your signed-in ChatGPT or Claude session. It never saves authentication data or sends data to its own server.",
  privacyLink:"Read the privacy policy ↗",faqEyebrow:"GOOD TO KNOW",faqTitle:"Frequently asked questions",
  ...
  footer:"Independent project. Not affiliated with OpenAI or Anthropic."
};
const hu = {};
...
let initial = 'en';
try { if (localStorage.getItem('quotaduck-site-language') === 'hu') initial = 'hu'; } catch {}
setLanguage(initial);
